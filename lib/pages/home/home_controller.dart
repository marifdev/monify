...
//   //     getCategories(_model.user!.uid).then((value) {
//   //       if (value.isNotEmpty) {
//   //         _model.loadCategories(value);
//   //       } else {
//   //         for (var element in kCategoryList) {
//   //           addCategory(element, _model.user!.uid);
//   //         }
//   //         _model.loadCategories(kCategoryList);
//   //       }
//   //     });
//   //     getTransactions(_model.user!.uid).then((value) {
//   //       _model.loadTransactions(value);
//   //     });
//   //     getAccounts(_model.user!.uid).then((value) {
//   //       if (value.isNotEmpty) {
...
//   //         );
//   //         addAccount(initialAccount, _model.user!.uid);
